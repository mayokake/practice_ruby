...
test = ArrayForMatrix.new
test01 = test.array_for_stat
test02 = test.array_for_ar_option
test00 = test.l_option

test2 = MatrixForL.new(test01, test02)
test20 = test2.transposed_matrix
...
if test00 == true
  puts "total #{test2.blocks_number.sum}"
  another_display(test20)
end
