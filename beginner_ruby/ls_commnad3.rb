...
test = ArrayForMatrix.new
test1 = test.array_for_ar_option
test00 = test.l_option

test2 = MatrixForNoL.new(test1)
# p test3 = test2.number_of_columns
# p test4 = test2.length_of_array
# p test5 = test2.width_of_row
# p test6 = test2.length_of_row
# p test7 = test2.number_of_adding_strings
# p test8 = test2.warikireru_array
# p test0 = test2.size_ajustment
# p test9 = test2.array_for_transpose
test10 = test2.transposed_array
...
output_display(test10) if test00 == false
...
# def number_of_columns # done
#   3
# end

# def length_of_array # done
#   array_for_a_option.size
# end

# def width_of_row # done
#   array_for_a_option.map(&:size).max > 25 ? array_for_a_option.map(&:size).max : 25
# end

# def length_of_row # done
#   if (length_of_array.divmod(number_of_columns)[1]).zero?
#     length_of_array.divmod(number_of_columns)[0]
#   else
#     length_of_array.divmod(number_of_columns)[0] + 1
...
# def array_for_transpose # done
#   ary = array_for_ar_option + Array.new(for_add_strings, '')
#   three_dimension_array = []
...
# def symlink
#   array_for_ar_option.map.with_index do |file, index|
